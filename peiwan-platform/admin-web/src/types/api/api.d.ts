...
declare namespace Api {
  ...
  namespace Business {
    ...
    interface ServiceItem { id:number;gameId:number;gameName:string;serviceCode:string;serviceName:string;serviceType:string;description?:string;sortNo:number;enabled:boolean;createTime?:string }
    interface ProductSku { id?:number;skuCode:string;skuName:string;price:number;marketPrice?:number;unitType:'HOUR'|'GAME'|'ORDER';unitCount:number;minQuantity:number;maxQuantity?:number;stockMode:'UNLIMITED'|'LIMITED';stockQuantity?:number;serviceMinutes?:number;enabled:boolean;sortNo:number }
    ...
    interface Order { id:number;orderNo:string;customerId:number;customerUsername:string;customerNickname?:string;assignedPlayerId?:number;playerName?:string;productName?:string;orderStatus:string;totalAmount:number;payableAmount:number;paidAmount:number;contactName?:string;contactPhone?:string;customerRemark?:string;cancelReason?:string;createTime:string;items?:OrderItem[];gameProfile?:OrderGameProfile;statusLogs?:OrderStatusLog[] }
    ...
    interface PlayerGame { id?:number;gameId:number;gameName?:string;gameNickname?:string;gameAccount?:string;serverName?:string;rankName?:string;rankLevel?:number;experienceYears?:number;introduction?:string;proofUrl?:string;primary:boolean;enabled:boolean;positionIds?:number[];primaryPositionId?:number }
