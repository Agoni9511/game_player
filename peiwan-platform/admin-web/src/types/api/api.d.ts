...
declare namespace Api {
  ...
  namespace Business {
    ...
    interface OrderCommitment { id:number;ruleType:string;title:string;targetValue?:number;targetUnit?:string;description?:string;failureAction?:string;sortNo:number }
