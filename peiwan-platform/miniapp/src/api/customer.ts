...
export const getCatalogProducts = (data: { keyword?: string; gameId?: number; categoryId?: number; current?: number; size?: number } = {}) => request<PageResult<RecordData>>({ url: '/api/customer/catalog/products', method: 'GET', data: { current: 1, size: 20, ...data } })
