  ...
  <view class="orders-page">
    ...
    <view class="content">
      <view v-for="order in filteredOrders" :key="String(order.id)" class="order-card" @click="open(Number(order.id))">
        ...
        <view class="game-row">
          <view class="game-icon"><image src="/static/icons/gamepad.png" /></view>
