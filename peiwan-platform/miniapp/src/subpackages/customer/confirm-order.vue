<template>
  <view class="confirm-page">
    ...
    <view class="card product-card">
      ...
      <view class="product-main"><view class="product-name">{{ product.productName }}</view><view class="sku-name">{{ selectedSku.skuName || '服务规格' }}</view><view class="unit-price">¥{{ money(selectedSku.price) }} / {{ unitLabel(selectedSku.unitType) }}</view></view>
    </view>
    ...
    <view class="bottom-bar"><view class="total"><text>应付</text><strong>¥{{ totalAmount }}</strong></view><button class="submit" :disabled="submitting" @click="submit">{{ submitting ? '正在提交...' : '提交订单' }}</button></view>
  </view>
</template>
